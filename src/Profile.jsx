...
const Profile = () => {
  ...
  <div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        <label className="block text-sm font-medium text-green-900 mb-1">Date of Birth</label>
        <div className="flex gap-2">
          <select className="w-1/3 border border-green-300 rounded-md px-2 py-2 bg-white" disabled={!isEditing}>
            <option>DD</option>
            {[...Array(31)].map((_, i) => (
  ...
  {/* PERSONAL ADDRESS */}
  <div>
    <h3 className="text-lg font-semibold text-green-800 mb-4">PERSONAL ADDRESS</h3>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        <label className="block text-sm font-medium text-green-900 mb-1">Address 1</label>
        <input
          type="text"
          name="address"
      ...
      <div>
        <label className="block text-sm font-medium text-green-900 mb-1">City</label>
        <select className="w-full border border-green-300 rounded-md px-4 py-2 bg-white" disabled={!isEditing}>
      ...
      <div>
        <label className="block text-sm font-medium text-green-900 mb-1">Country</label>
        <select className="w-full border border-green-300 rounded-md px-4 py-2 bg-white" disabled={!isEditing}>
          <option>Please select</option>
      ...
      <div>
        <label className="block text-sm font-medium text-green-900 mb-1">ZIP Code</label>
        <input
          type="text"
          className="w-full border border-green-300 rounded-md px-4 py-2"
          disabled={!isEditing}
