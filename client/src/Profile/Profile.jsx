      ...
      <div className="bg-white border-b border-gray-200">
        <div className="flex items-center justify-between px-4 py-4">
          <div className="flex items-center">
            ...
            <h1 className="text-lg font-medium text-gray-900">Back</h1>
          </div>
        ...
        <div className="w-64 bg-white min-h-screen border-r border-gray-200">
          <div className="p-6">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="mt-3 font-medium text-gray-900">Anonymous</h2>
            ...
            <nav className="space-y-1">
              ...
              <button className="w-full flex items-center px-3 py-2 rounded-md hover:bg-gray-50">
                ...
                <span className="text-sm text-gray-700">Education Plan</span>
              </button>
            </nav>
          </div>
        </div>
