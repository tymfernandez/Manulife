...
export default function SignUp() {
  ...
  const validateManulifeEmail = (email) => {
    const manulifeDomains = ['@manulife.com', '@manulife.ca', '@manulife.ph']
    return manulifeDomains.some(domain => email.toLowerCase().endsWith(domain))
  }

  const handleSubmit = async (e) => {
    e.preventDefault()
    
    if (!validateManulifeEmail(email)) {
      setError('Please use a valid Manulife email address (@manulife.com, @manulife.ca, or @manulife.ph)')
      return
    }
