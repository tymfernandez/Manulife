...
const { signUp, signIn, signOut, updateProfile, getProfile, changePassword, resetPassword, updatePassword, resetPasswordConfirm } = require('./routes/auth');
...
app.post('/api/auth/reset-password-confirm', resetPasswordConfirm);
